...
export default function Featured({product}) {
    ...
    return (
        <div className="pt-[5.5em] pb-10 px-8 sm:px-10 lg:px-14 xl:px-[14vw] 2xl:px-[20vw] sm:px-5 bg-[#222] text-white flex flex-col items-around sm:justify-around sm:flex-row">
            <div className="flex flex-col mb-5 sm:mb-0 sm:max-w-[40%] sm:justify-center sm:mb-5">
                ...
                <div className="buttonDiv flex my-3">
                    <Link href={`/product/${product._id}`} className="flex justify-center items-center">Read More</Link>
            ...
            <div className="flex flex-col items-start justify-center max-w-[95%] sm:max-w-full">
                <img src={product.images[0]} className="max-w-full md:min-w-[280px] min-h-full max-h-[240px] md:max-h-[270px] rounded-lg"/>
            </div>
