    ...
    return (
        <div className="pt-[5.5em] pb-10 px-8 sm:px-5 bg-gray-800 text-white flex flex-col items-around sm:justify-around sm:flex-row">
            <div className="flex flex-col mb-5 sm:mb-0 sm:max-w-[40%] sm:justify-center sm:mb-5">
                <h1 className="text-[2.1em]">Hottest New Style!</h1>
                <p className="text-[#aaa] text-[.8rem]">
                    lorem ipsum lor lore lorum ipsum ore lore foru lorem fr lore lorum ipsum. lorem ipsum lor lore lorum ipsum ore lore foru lorem fr lore lorum ipsum. lorem ipsum lor lore lorum ipsum ore lore foru lorem fr lore lorum ipsum.
                </p>
                <div className="buttonDiv flex my-3">
                    <button className="flex justify-center items-center">Read More</button>
            ...
            <div className="flex flex-col items-end justify-center max-w-[85%] sm:max-w-full">
