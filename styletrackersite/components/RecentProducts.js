                    ...
                    <div className="">
                        ...
                        <div className="ml-3 mt-2">
                            ...
                            <div className="flex flex-wrap items-center gap-2 mt-1 sm:gap-2 mb-4">
                                ...
                                <button className="absolute ml-[14.5%] sm:ml-[10%] lg:ml-[7%] flex items-center text-[#5542F6] gap-1 w-fit border-[1px] border-[#5542F6] px-2 py-1 rounded-lg text-[.6em] lg:text-[.8em] hover:border-2">
