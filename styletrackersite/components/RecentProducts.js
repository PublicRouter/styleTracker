...
export default function RecentProducts({ products }) { 
    ...
    return (
        <div className="mx-5 sm:mx-10 md:mx-8 lg:mx-[6em]">
            <h1 className="text-[#222] text-[32px] ml-4 p-6">Newly Added Products</h1>
            <div className="grid grid-cols-2  gap-6 p-4 mx-4 text-[#222] mb-[6em] sm:grid-cols-3 md:grid-cols-4">
                    ...
                    <div className="">
                        ...
                        <div className="ml-3 mt-2">
                            ...
                            <div className="flex flex-wrap items-center gap-2 mt-1 sm:gap-2 mb-4">
                                ...
                                <button onClick={() => addProduct(product._id)} className="absolute ml-[14.5%] sm:ml-[10%] lg:ml-[7%] flex items-center text-[#5542F6] gap-1 w-fit border-[1px] border-[#5542F6] px-2 py-1 rounded-lg text-[.6em] lg:text-[.8em] hover:border-2">
