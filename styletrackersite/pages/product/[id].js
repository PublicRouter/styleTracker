                ...
                <div className="grid grid-cols-1 max-w-[350px] md:max-w-full md:grid-cols-2 gap-[40px] my-[50px]">
                    ...
                    <div>
                        ...
                        <div className="flex gap-3 items-center">
                            ...
                            <div>
                                <button className="cartButton text-[.7em]" primary onClick={() => addProduct(product._id)}>
                    ...
                    <Link className="mt-6 text-[#aaa] hover:text-black w-fit" href='/products'> ← Products</Link>
